	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord311 = IN.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float2 texCoord359 = IN.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner360 = ( 1.0 * _Time.y * float2( 7,9 ) + texCoord359);
				float temp_output_362_0 = ( _TimeParameters.x * 60.0 );
				...
				float2 temp_output_361_0 = ( texCoord311 + NoiseGlitch386 );
				...
				float2 texCoord388 = IN.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner337 = ( 1.0 * _Time.y * float2( 0,0.5 ) + texCoord388);
				float Scanline389 = tex2D( _Mask, panner337 ).r;
				float2 texCoord390 = IN.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float SmallScanline391 = tex2D( _Mask, texCoord390 ).g;
				...
				float3 BaseColor = ( _AlbedoPower * lerpResult335 ).rgb;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 texCoord311 = IN.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				float2 texCoord359 = IN.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner360 = ( 1.0 * _Time.y * float2( 7,9 ) + texCoord359);
				float temp_output_362_0 = ( _TimeParameters.x * 60.0 );
				float clampResult372 = clamp( ( sin( ( temp_output_362_0 * 0.7 ) ) + sin( temp_output_362_0 ) + sin( ( temp_output_362_0 * 1.3 ) ) + sin( ( temp_output_362_0 * 2.5 ) ) ) , 0.0 , 1.0 );
				float Flicking1377 = clampResult372;
				...
				float2 panner312 = ( 1.0 * _Time.y * float2( 0,0.2 ) + temp_output_361_0);
				float2 panner331 = ( 1.0 * _Time.y * float2( -0.2,0 ) + temp_output_361_0);
				float2 texCoord388 = IN.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner337 = ( 1.0 * _Time.y * float2( 0,0.5 ) + texCoord388);
				float Scanline389 = tex2D( _Mask, panner337 ).r;
				float2 texCoord390 = IN.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				float SmallScanline391 = tex2D( _Mask, texCoord390 ).g;
				float temp_output_343_0 = ( _TimeParameters.x * 20.0 );
				float clampResult349 = clamp( ( sin( ( temp_output_343_0 * 0.7 ) ) + sin( temp_output_343_0 ) + sin( ( temp_output_343_0 * 1.3 ) ) + sin( ( temp_output_343_0 * 2.5 ) ) ) , 0.7 , 1.0 );
				float Flicking2383 = clampResult349;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 panner312 = ( 1.0 * _Time.y * float2( 0,0.2 ) + temp_output_361_0);
				float2 panner331 = ( 1.0 * _Time.y * float2( -0.2,0 ) + temp_output_361_0);
				float2 texCoord388 = IN.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner337 = ( 1.0 * _Time.y * float2( 0,0.5 ) + texCoord388);
				float Scanline389 = tex2D( _Mask, panner337 ).r;
				float2 texCoord390 = IN.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float SmallScanline391 = tex2D( _Mask, texCoord390 ).g;
				float temp_output_343_0 = ( _TimeParameters.x * 20.0 );
				float clampResult349 = clamp( ( sin( ( temp_output_343_0 * 0.7 ) ) + sin( temp_output_343_0 ) + sin( ( temp_output_343_0 * 1.3 ) ) + sin( ( temp_output_343_0 * 2.5 ) ) ) , 0.7 , 1.0 );
				float Flicking2383 = clampResult349;
...
Node;AmplifyShaderEditor.SamplerNode;358;-1662.119,-416.2332;Inherit;True;Property;_asdasd;asdasd;5;0;Create;True;0;0;0;False;0;False;-1;None;8714712f4d4a886488df03a7007d0adc;True;0;False;white;Auto;False;Instance;338;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.RangedFloatNode;375;-1372.087,-103.6745;Float;False;Property;_Distort;Distort;6;0;Create;True;0;0;0;False;0;False;0.35;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;330;263.8311,-184.9648;Inherit;True;Property;_TextureSample2;Texture Sample 2;0;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;308;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SamplerNode;308;258.3858,-667.6701;Inherit;True;Property;_Emission;Emission;0;0;Create;True;0;0;0;False;0;False;-1;None;ad60ea0298b7fb44fb46d84220ab784e;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SamplerNode;356;-1654.909,-699.3875;Inherit;True;Property;_TextureSample4;Texture Sample 4;5;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;338;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SamplerNode;338;-1667.682,-934.3598;Inherit;True;Property;_Mask;Mask;5;0;Create;True;0;0;0;False;0;False;-1;None;8714712f4d4a886488df03a7007d0adc;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.RangedFloatNode;396;1036.613,31.02431;Inherit;False;Constant;_Float0;Float 0;7;0;Create;True;0;0;0;False;0;False;0.5;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;304;1466.508,-1035.995;Float;False;Property;_Background;Background;1;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;False;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;306;1470.388,-792.8857;Float;False;Property;_EmissColor;EmissColor;2;0;Create;True;0;0;0;False;0;False;1,1,1,0;0,0.6689658,1,0;False;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.RangedFloatNode;323;1683.938,-545.0815;Float;False;Property;_EmissionPower;Emission Power;4;0;Create;True;0;0;0;False;0;False;0;5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;325;1744.504,-999.7843;Float;False;Property;_AlbedoPower;Albedo Power;3;0;Create;True;0;0;0;False;0;False;0;0.2;0;0;0;1;FLOAT;0
...
WireConnection;398;0;324;0
WireConnection;398;2;322;0
ASEEND*/
//CHKSM=321A45F4E9B9619444F16B259E3C34083CD2B9EE