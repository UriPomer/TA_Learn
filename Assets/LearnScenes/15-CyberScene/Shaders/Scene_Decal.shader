	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float lerpResult5 = lerp( _MinRoughness , _MaxRoughness , tex2D( _RoughnessMap, uv_RoughnessMap ).r);
				...
				float Occlusion = 1;
				float Alpha = tex2D( _OpacityMask, uv_OpacityMask ).r;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				surfaceDescription.Alpha = tex2D( _OpacityMask, uv_OpacityMask ).r;
...
ASEEND*/
//CHKSM=4735F5C2AE7352ED1DEDC8B52DB46A1684613399